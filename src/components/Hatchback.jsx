...
Command: npx gltfjsx@6.2.3 hatchback.glb
*/
...
export function Hatchback({ entity }) {
  const group = useRef();
  const meshRef = useRef();
  const [debug] = useStore((state) => [state.debug]);
  const [lines, setLines] = useState([]);

  const { scene, materials } = useGLTF('/Models/newModels/Vehicles/hatchback.glb');
      ...
      <mesh ref={meshRef} castShadow position={[entity.position.x, 0.025, entity.position.z]}>
        <group ref={group} dispose={null} scale={(0.05, 0.05, 0.05)}>
          <group position={[0, -0.04, 0]}>
            <mesh geometry={nodes.Car_1.geometry} material={materials.Base} />
            <mesh geometry={nodes.Car_2.geometry} material={materials.Glass} />
            <mesh geometry={nodes.Car_3.geometry} material={materials.Headlight} />
            <mesh geometry={nodes.Car_4.geometry} material={materials.Silver} />
            <mesh geometry={nodes.Car_5.geometry} material={materials.Black} />
            <mesh geometry={nodes.Car_6.geometry} material={materials.LicensePlate} />
            <mesh geometry={nodes.Car_7.geometry} material={materials.TailLight} />
          </group>
...
useGLTF.preload('/Models/newModels/Vehicles/hatchback.glb');
